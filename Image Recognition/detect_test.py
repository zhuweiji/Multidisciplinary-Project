...
# I ADDED THIS AT LINE 205 # This saves an image to a separate folder. This ensures we can do the tiling thing as in the requirements.
            if o != 'null':
                save_it = "C:/Users/micha/OneDrive/Desktop/PRED/content/PRED/collage_actual/imageClass_{0}.jpg".format(names[c])
...
def main(opt):
    ...
    label = run(**vars(opt, seen_images, seen_labels))
    print(label)


if __name__ == "__main__":
    opt = parse_opt()
    main(opt, seen_images, seen_labels)
'''
